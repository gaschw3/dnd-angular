...
@Component({
  selector: 'app-epic-boons',
  templateUrl: './epic-boons.component.html',
  styleUrls: ['./epic-boons.component.scss']
})
export class EpicBoonsComponent implements OnInit {

  feats: Feat[] = [];
  currFeat: Feat;

  public getJSON(): Observable<any> {
    return this.http.get("assets/data/2024/epic-boons.json")
  }
  ...
  setCurrAncestry(clicked): void {
    ...
    this.location.go("/epic-boons/" + this.currFeat.id)
  }
}
